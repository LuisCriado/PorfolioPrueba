...
const linkedinUrl = 'https://www.linkedin.com/in/luis-criado-b4a28a243/'
const gitHubUrl = 'https://github.com/LuisCriado'
  ...
  return (
    <Center h={'100%'} flexDirection={'column'}>
      ...
      <ContactCTA
        ...
        onClick={() =>
          ((window as Window).location = 'mailto:werty.dev@hotmail.com')
        }
      >
        <Text>Werty.dev@hotmail.com</Text>
      </ContactCTA>
          ...
          >
            <>
              <Icon
                ...
                mr={'5px'}
              />
              <Text fontSize={{ base: 'md', md: 'lg', lg: 'xl' }}>Resumen</Text>
            </>
          </ContactCTA>
        </a>
      </HStack>
